...
class ConsentOtpWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppContainer(
      ...
      child: Row(
        children: [
          //Use Expand here instead of inside ConsentOtpNumberWidget
          ConsentOtpNumberWidget(
            otp: otp,
          ),
          //Use AppButton.secondary() instead of AppSecondaryButtonLayout and i would be great if you make it in separate file
